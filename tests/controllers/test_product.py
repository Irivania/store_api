...
@pytest.mark.asyncio
async def test_controller_create_should_return_success(client, products_url, clear_collections):
...
@pytest.mark.asyncio
async def test_controller_get_should_return_not_found(client, products_url, clear_collections):
...
@pytest.mark.asyncio
async def test_controller_delete_should_return_not_found(client, products_url, clear_collections):
